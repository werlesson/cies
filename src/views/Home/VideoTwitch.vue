<template>
  <section class="twitch-live-video pt-5">
    <div class="container text-white pt-5 pb-5">
      <h2>Live do sorteio dos grupos as 15h <i class="fa fa-circle" style="color: red;"></i></h2>
...
export default {
  ...
  created() {
    // injetar script no DOM - não funciona quando da F5
...
({
    ...
    33: function (e, t, n) {
        ...
        function i(e) {
            return function (t) {
                if ((0, o.isTwitchOrigin)(t.origin))
                    return e(t)
            }
        }
        t.__esModule = !0,
    ...
    75: function (e, t, n) {
        ...
        t.__esModule = !0;
        var r = {};
        r.IFRAME_INDEX = "https://embed.twitch.tv",
        t.default = r
    },
    76: function (e, t, n) {
        "use strict";
    ...
    82: function (e, t) {
        ...
        n.prototype.emit = function (e) {
            ...
            if (r(n))
                ...
                for (a = Array.prototype.slice.call(arguments, 1), l = n.slice(), i = l.length, u = 0; u < i; u++)
                    l[u].apply(this, a);
            return !0
        },
        n.prototype.addListener = function (e, t) {
            ...
            o(this._events[e]) && !this._events[e].warned && (i = s(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners) && i > 0 && this._events[e].length > i && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), "function" == typeof console.trace && console.trace()),
            this
        },
    ...
    91: function (e, t, n) {
        ...
        function s(e, t) {
            ...
            if (!u(e) && !a(e))
                throw new f.MissingParameterError("An element of type String or Element is required");
            if (!t || !t.channel && !t.video && !t.collection)
                throw new f.MissingParameterError("A channel, video, or collection id must be provided in options")
        }
        function a(e) {
        ...
        window.Twitch.Embed = function () {
            ...
            e.prototype.render = function () {
                ...
                if (!t)
                    throw new f.MissingElementError(this.target);
...
.twitch-live-video {
  width: 100%;
  height: 750px;
  background-image: url("~@/assets/img/twitch-video-bg.jpg");
